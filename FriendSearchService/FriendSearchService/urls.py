...
friend_request_router.register(
    r'friend_request', FriendRequestViewSet, basename='friend_request'
)
...
urlpatterns = [
    ...
    path(
        'api/v1/people/<int:user_id>/send_friend_requests/',
        PeopleViewSet.as_view({'post': 'send_friend_requests'}),
    ...
    path(
        'api/v1/friend_request/<int:user_id>/check_status/',
        FriendRequestViewSet.as_view({'get': 'check_status'}),
        name='check_status',
    ),
    path(
        'api/v1/friend_request/<int:user_id>/accept/',
        FriendRequestViewSet.as_view({'post': 'accept'}),
        name='accept_request',
    ),
    path(
        'api/v1/friend_request/<int:user_id>/reject/',
    ...
    path(
        'api/v1/friends/<int:user_id>/delete/',
        FriendsViewSet.as_view({'delete': 'delete'}),
        name='friend_delete',
    ),
]
